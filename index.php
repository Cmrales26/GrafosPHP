...
<body>
            ...
            <div class="Columnas">
                <div class="Columna_2 Columna">
                    ...
                    <form action="index.php" method="post" id="recorridoProfundidad">
                        <input type="text" name="NodoD"
                            placeholder="Ingrese el nodo para ver su recorrido de profundidad">
    ...
    <footer>
        <p>Creado y diseñado por: <a href="https://aulavirtual.cuc.edu.co/moodle/user/profile.php?id=149989"
                ...
                rel="noopener noreferrer">@Yan De la Torre</a></p>
    </footer>
